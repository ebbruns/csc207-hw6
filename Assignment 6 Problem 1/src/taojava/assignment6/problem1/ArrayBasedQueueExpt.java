    ...
    throws Exception
  {
    ...
    ReportingLinearStructure<String> expt =
        new ReportingLinearStructure<String>(
                                             new LoopingArrayBasedQueue<String>(
                                                                                8),
                                             "expt.");

    LoopingArrayBasedQueue<String> thing =
        new LoopingArrayBasedQueue<String>(4);

    LoopingArrayBasedQueueIterator<String> loopIt =
        new LoopingArrayBasedQueueIterator<String>(thing);

    thing.put("Elmo");
    System.out.println(thing.peek());
    thing.put("Elmo's mom");
    thing.put("Elmo's grandmother");
    thing.put("Elmo's grandmother twice removed");

    System.out.println(loopIt.next());
    System.out.println(loopIt.next());
    System.out.println(loopIt.next());
    System.out.println(loopIt.next());
    System.out.println(loopIt.hasNext());
    System.out.println(loopIt.next());
    System.out.println(loopIt.next());
    System.out.println(loopIt.next());
    System.out.println(loopIt.next());
    ...
    // expt.get();
    // expt.put("bigbird");
    // expt.put("bigbird's sister");
    // expt.put("bigbird's brother");
    // expt.put("bigbird's cousin");
    // expt.put("bigbird's other cousin raoul");
